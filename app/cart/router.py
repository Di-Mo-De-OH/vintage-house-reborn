...
from app.cart.utils.responses import CART_ADD_RESPONSES, CART_AUTH_RESPONSES
...
@router.post(
    ...
    response_model=CartAddProductResponse,
    responses=CART_ADD_RESPONSES,
)
...
@router.get("", status_code=status.HTTP_200_OK, response_model=CartResponse, responses=CART_AUTH_RESPONSES)
