...
def upgrade() -> None:
    ...
    sa.Column('category', sa.Enum('OUTER', 'TOP', 'BOTTOM', 'SHOES', 'ACCESSORY', name='category'), nullable=False),
    sa.Column('status', sa.Enum('ON_SALE', 'SOLD_OUT', 'HIDDEN', name='status'), nullable=False),
